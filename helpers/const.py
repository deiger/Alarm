...
ARGS = [
    {
        ARG_KEY: "ssl_cert",
        ARG_HELP: "Path to SSL certificate file"
    },
    {
        ARG_KEY: "ssl_key",
        ARG_HELP: "Path to SSL key file"
    },
    {
        ARG_SHORT_KEY: "p",
        ARG_KEY: "port",
    ...
    {
        ARG_KEY: "mqtt_host",
        ARG_HELP: "MQTT broker hostname or IP address",
    },
    {
        ARG_KEY: "mqtt_port",
        ARG_HELP: "MQTT broker port",
        ARG_TYPE: int
    },
    {
        ARG_KEY: "mqtt_client_id",
        ARG_HELP: "MQTT client id"
    },
    {
        ARG_KEY: "mqtt_user",
        ARG_HELP: "<user:password> for the MQTT channel"
    },
    {
        ARG_KEY: "mqtt_topic",
        ARG_HELP: "MQTT topic",
        ARG_DEFAULT: "pima_alarm"
    },
    {
